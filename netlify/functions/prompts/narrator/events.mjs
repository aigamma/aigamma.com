...
First-pass anomaly rules:
  ...
  - VIX percentile rank > 80: severity 1-2 (heightened event-vol regime).
  - Term structure backwardation: severity 2 (event premium in the front).
  - Otherwise: severity 0 or 1, since this page's content is mostly forward-looking and benefits less from real-time narration.
