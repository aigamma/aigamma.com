...
Severity 1 floor. When none of the above is firing, write severity 1 with a one-line headline naming the prevailing vol environment (VIX percentile rank, term-structure regime) as the standing context for the calendar reader. The page always speaks.
