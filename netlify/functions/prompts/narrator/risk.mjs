...
First-pass anomaly rules. The page's models produce their most distinctive readings when smile shape is pronounced; describe input shape in those terms.
  - Front-month 25Δ RR more negative than -3 percentage points: severity 1-2 — Vanna-Volga's three-anchor reconstruction will produce a clearly asymmetric smile, and the Hull-White minimum-variance delta will diverge sharply from BSM delta on OTM puts.
  ...
  - Cross-model Greek divergence likely to be visible on the page: when ATM IV > 30%, the Heston Greeks and Bachelier Greeks will diverge from BSM by enough to dominate the comparison panel. Severity 1.
