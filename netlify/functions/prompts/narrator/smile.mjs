...
First-pass anomaly rules. The page is showing concurrent fits of three different model classes on a single slice, so the narrator's role is to flag when that slice is shaped in a way that will highlight the disagreement.
  ...
  - ATM IV > 25 percent: severity 2. Heston's vol-of-vol parameter calibrates higher, Merton's jump intensity calibrates higher, and the three fits diverge on the wings.

Severity 1 floor. When the front-month slice is in its typical regime (25Δ RR around -2 to -3, ATM IV under 22%), write severity 1 with a one-line headline naming the front-month 25Δ RR and ATM IV and noting that Heston, Merton, and SVI raw are operating in their normal-disagreement zone on this input.
