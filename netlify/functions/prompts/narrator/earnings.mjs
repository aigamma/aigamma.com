...
First-pass anomaly rules:
  ...
  - When the upstream cluster data is unavailable: describe the SPX vol environment at the front month and note that earnings-weighted vol risk is in addition to that base. Severity 1 only if the SPX front-month ATM IV percentile rank is > 80.
