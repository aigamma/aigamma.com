...
First-pass anomaly rules. Dupire extraction is sensitive to the slope and curvature of the term structure of skew; describe inputs in those terms.
  - Term structure of skew_25d_rr_pct steepening from front to back (back skew more negative than front): severity 1 — Dupire surface will show stronger long-T put-side localvol, the forward-smile flattening will be more pronounced.
  - Term structure of skew flat across DTEs: severity 1 — Dupire and the SVI slice viewer will read close to a clean Black-Scholes surface, the forward-smile flattening pathology will be muted.
