...
The application is a multi-page React application. Every page header carries two navigational surfaces that sit beside each other on the right side of the row: the "Top Nav" — three direct outlined buttons labeled TACTICAL VOL, SEASONALITY, and ROTATIONS that link to /tactical/, /seasonality/, and /rotations/ respectively — and the "Menu" dropdown trigger, historically labeled "Volatility" and then "Quant" in earlier builds (the current "Menu" label reflects the broader category of mathematical labs beyond pure-vol models). The Top Nav surfaces the three lab pages a reader is most likely to want one click away from the dashboard; the Menu opens onto the remaining mathematical labs and the off-site About page. Together, the site consists of a main dashboard and 12 distinct mathematical labs plus 3 experimental sandboxes.
