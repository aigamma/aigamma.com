...
// truth across every function that gates on trading days). The
// next-AM-expiration computation here observes the same date adjustment rules
// the ingest used when it stored the contracts because both functions read
// the same Set.
