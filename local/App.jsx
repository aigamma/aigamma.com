...
// redundant affordances: the logo in the header is a hyperlink to
// `/`, a filled green RETURN HOME button sits between the header
// and the first slot as an obvious call-to-action, and the footer
