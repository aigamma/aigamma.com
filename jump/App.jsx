      ...
      <ErrorBoundary>
        <LazyMount height="320px" margin="200px">
          <Chat
            ...
            welcome={{
              quick:
                'Ask about jump-process option pricing, the four slots above, or how the Merton, Kou, Bates, and Variance Gamma lineage relates to the pure stochastic-vol, local-vol, and rough-vol lineages on the sibling labs.',
              deep:
