    ...
    <div className="app-shell page-shell">
      <header className="page-header">
        <div className="page-brand">
          ...
          >
            <span className="page-badge__desktop-text">Discrete</span>
            <span className="page-badge__mobile-text">Discrete</span>
          </span>
        </div>
        <TopNav />
        <a
      ...
      <ErrorBoundary><PageNarrator page="/discrete/" /></ErrorBoundary>
      ...
      <ErrorBoundary>
        <LazyMount height="320px" margin="200px">
          <Chat
            ...
            welcome={{
              quick:
                'Ask about the six models above, how discrete pricing engines (binomial, trinomial) relate to parametric surfaces (SVI raw, natural, JW, SSVI), or how the two schools work together on a production vol surface.',
              deep:
